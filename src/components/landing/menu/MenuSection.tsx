...
export default function MenuSection() {
  const menuImages = [
    { src: "/assets/landing/illustrations/food1.svg", alt: "Portuguese Desserts" },
    { src: "/assets/landing/illustrations/food2.svg", alt: "Traditional Ingredients" },
    { src: "/assets/landing/illustrations/food3.svg", alt: "Portuguese Dish" },
  ];
