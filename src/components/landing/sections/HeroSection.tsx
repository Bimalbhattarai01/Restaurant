  ...
  return (
    <section className="relative flex flex-col items-center justify-center w-full min-h-[125vh] overflow-hidden bg-white text-white">
      <div className="absolute inset-0">
        <Image src="/assets/landing/illustrations/Hero.svg" alt="Hero Background" fill priority className="object-cover brightness-[0.85]" />
      </div>
      ...
      <div className="relative z-20 mt-[120px]">
        <Image
          src="/assets/landing/menu/Dish.png"
          alt="Main Dish"
          width={920}
          height={820}
